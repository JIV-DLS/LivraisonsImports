...
@Component({
  selector: 'app-transit-add',
  templateUrl: './transit-add.component.html',
  styleUrls: ['./transit-add.component.scss']
})
export class TransitAddComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.transit.navire=new Navire();
    this.transit.marchandise=new Marchandise();
    this.transit.societe= new Societe(); 
  }
  ...
  onSubmit(transit) {
    ...
    this.transitsService.addTransit(transit.value)
      .subscribe(response => {
